            ...
            <div class="mt-2">
                <div>
                    <label class="inline-flex items-center">
                        <input value="<?php echo $oldFormData['tos'] ?? true ? 'checked' : ''; ?>" name="tos" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50" type="checkbox" />
